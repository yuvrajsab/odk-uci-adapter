...
export const slrTemplate = (name: string, link: string): string => {
  const link2 = 'http://bit.ly/-Yes_';
  return `प्रिय अभिभावक! ${name} का लर्निंग रिकॉर्ड देखने के लिए ${link} पर क्लिक करें। कृपया इस रिकॉर्ड के द्वारा ${name} के प्रदर्शन का विश्लेषण करें और शिक्षकों से मिलकर इस रिकॉर्ड पर विस्तृत चर्चा करें ताकि भविष्य में उनके शिक्षण अधिगम में सुधार हो सके। समग्र शिक्षा, हिमाचल प्रदेश।  शिक्षा विभाग द्वारा ऐसे एसएमएस निरंतर पाने के लिए कृपया ${link2} पर क्लिक करें।`;
};
