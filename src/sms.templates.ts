...
export const slrTemplate = (name: string): string =>
  `प्रिय अभिभावक!स्कूल की छुट्टियां date से date तक हैं। कृपया ${name} को date से रोज़ स्कूल भेजना सुनिश्चित करें। समग्र शिक्षा, हिमाचल प्रदेश`;
